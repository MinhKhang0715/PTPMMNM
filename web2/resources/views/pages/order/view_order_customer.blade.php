                ...
                <table class="table table-condensed">
                    ...
                    <tbody>
                         ...
                         <?php
                            $total = 0;
                        ?>
                         @foreach($order_d as $key => $order) <!--Lấy giá trị của $content truyền vào $v_content -->
                         <?php
                        ...
                        <tr>
                            ...
                            <td class="cart_description">  <!-- Cập Nhật Số Lượng Sản Phẩm Giỏ Hàng bằng phương thức post-->
                                <div >
